...
if(PR_UNIRENDER_WITH_CYCLES)
    ...
    if(UNIX)
        ...
        pr_install_directory("${DEPENDENCY_CYCLES_LIBRARY_INSTALL_LOCATION}/" INSTALL_DIR "${CYCLES_INSTALL_DIR}/" PATTERN "*" PATTERN "*.ptx" EXCLUDE PATTERN "*.cubin" EXCLUDE PATTERN "*.zst" EXCLUDE)
        pr_install_directory("${DEPENDENCY_CYCLES_LIBRARY_INSTALL_LOCATION}/" INSTALL_DIR "${CYCLES_INSTALL_DIR}/lib/" PATTERN "*.ptx" PATTERN "*.cubin" PATTERN "*.zst")
    else()
